...
function byCharLogical(state, range, forward) {
  ...
  if (pos == (forward ? line.to : line.from))
    ...
    pos = line.from + findClusterBreak2(line.text, pos - line.from, forward);
  return EditorSelection.cursor(pos, forward ? -1 : 1);
}
...
var previousDiagnostic = (view) => {
  ...
  if (lastFrom == null || prevFrom == null && lastFrom == sel.from)
    return false;
  let from = prevFrom !== null && prevFrom !== void 0 ? prevFrom : lastFrom, to = (_a2 = prevTo !== null && prevTo !== void 0 ? prevTo : lastTo) !== null && _a2 !== void 0 ? _a2 : from;
    ...
    for (let iter = RangeSet.iter([lState.diagnostics]); ; iter.next()) {
      for (let i2 = 0; i2 < pending.length; i2++)
        if (!iter.value || iter.value.spec.diagnostics.indexOf(pending[i2]) < 0) {
          f(pending[i2], pendingStart[i2], lastEnd);
          pending.splice(i2, 1);
