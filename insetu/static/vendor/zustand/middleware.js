...
var require_middleware = __commonJS({
  "node_modules/zustand/middleware.js"(exports) {
    ...
    var getTrackedConnectionState = function getTrackedConnectionState2(name) {
    ...
    var extractConnectionInformation = function extractConnectionInformation2(store, extensionConnector, options) {
      if (store === void 0) {
        return {
          type: "untracked",
    ...
    var parseJsonThen = function parseJsonThen2(stringified, f) {
      var parsed;
      try {
    ...
    function createJSONStorage(getStorage, options) {
      ...
      var persistStorage = {
        getItem: function getItem(name) {
          var _getItem;
          var parse = function parse2(str2) {
            if (str2 === null) {
              return null;
            }
    ...
    var oldImpl = function oldImpl2(config, baseOptions) {
      return function(set, get, api) {
    ...
    var newImpl = function newImpl2(config, baseOptions) {
      return function(set, get, api) {
        var options = _extends({
...
export default require_middleware();
