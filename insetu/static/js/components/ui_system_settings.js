                        ...
                        ${Object.keys(this.workspaces).length > 0 ? html`
                            ...
                            <div style="display: flex; flex-direction: column; gap: 5px; margin-bottom: 15px;">
                                ${Object.entries(this.workspaces).map(([key, ws]) => {
                                    ...
                                    return html`
                                        <button style="margin: 0; background: ${isActive ? 'var(--input-bg)' : 'transparent'}; color: var(--text); text-align: left; padding: 6px; border: 1px solid ${isActive ? 'var(--border)' : 'transparent'}; cursor: pointer; border-radius: 4px; font-weight: ${isActive ? 'bold' : 'normal'};"
