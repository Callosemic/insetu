...
closed_at: null
sub_bucket: "None"
tags: [backend, refactor, decoupling, architecture]
---
...
- [ ] Ensure that route controllers only manage request extraction, payload mapping, and direct tenant scoping passes before handing execution off to domain engines.
