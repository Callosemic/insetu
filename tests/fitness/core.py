...
VFS_WRITE_WHITELIST = ["routes_fs.py", "fallback_bridge.py", "utils_core.py", "engine_format.py", "engine_git.py", "engine_gather.py", "cli.py", "workers.py", "engine_tracker.py", "engine_research.py", "vfs.py", "app.py", "auth.py", "engine_update.py", "engine_publish.py", "engine_cronic.py", "__init__.py"]
SQLITE_WHITELIST = ["db.py", "workers.py", "__init__.py"]  
