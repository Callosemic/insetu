...
* **[01 Engineering Standards](./01_engineering_standards.md)**: Baseline rules, VFS constraints, state immutability, and fitness functions.
* **[02 Extension API Contract](./02_extension_api_contract.md)**: Bootloader contracts, event bus hooks, and extension API specs.
